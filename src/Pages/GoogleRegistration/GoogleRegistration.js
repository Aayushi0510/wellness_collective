...
import GoogleSeekerRegistration from "./SeekerGoogleRegistration";
import GooglePractitionerreg from "./PractitonerGoogleReg";

const GoogleRegistartion = () => {
      ...
      <div className="container mx-auto py-12 min-h-screen ">
        <div className="flex justify-center items-center">
          <div className="md:w-3/5 w-full px-5 flex flex-col justify-center items-center ">
                ...
                <ul className="flex gap-4 w-full justify-center ">
                  <button
                      className={`text-center px-3 py-3 ${
                        activeLink === "seekers" ? "bg-gradient-to-br from-primary via-primary to-secondry hover:bg-gradient-to-br hover:from-secondry hover:via-primary hover:to-primary text-black" : ""
                      } rounded-xl py-1`}
                  ...
                  <li
                     className={`text-center px-3 py-3 ${
                      activeLink === "practitioners" ? "bg-gradient-to-br from-primary via-primary to-secondry hover:bg-gradient-to-br hover:from-secondry hover:via-primary hover:to-primary text-black" : ""
                    } rounded-xl py-1`}
            ...
            {seekers && (
              <div>
                <GoogleSeekerRegistration />
              </div>
            )}
            {practitioners && (
              <div>
                <GooglePractitionerreg />
              </div>
            )}
...
export default GoogleRegistartion;
