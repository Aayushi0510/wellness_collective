...
const CreateEventForm = ({ onSubmit, handleImageSelect ,loading }) => {

  return (
    <div className="py-5 d-flex">
      <div className="flex justify-end container text-gray-100 mx-auto -pt-8 gap-5">
        <Link
          to="/dashboard/createrecurring"
